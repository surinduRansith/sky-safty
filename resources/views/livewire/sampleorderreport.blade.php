    ...
    <div class="overflow-x-auto mt-4">
       ...
       <table class="table table-zebra min-w-full divide-y divide-gray-200 dark:divide-gray-700 mt-4">
        <thead class="bg-gray-50 dark:bg-gray-700">
            <tr>
                <th class="px-6 py-3 text-left text-sm font-medium text-gray-700 dark:text-gray-300" >Sample Invoice No</th>
                <th class="px-6 py-3 text-left text-sm font-medium text-gray-700 dark:text-gray-300" >Company</th>
                <th class="px-6 py-3 text-left text-sm font-medium text-gray-700 dark:text-gray-300" >Sample Invoice Date</th>
                ...
                <tr>
                   ...
                   <td  > {{ $report->company}}</td>
                    ...
                    <td class="w-40">
                        ...
                        <button onclick="my_modal_1{{ $report->id  }}.showModal()"
                    ...
                    <dialog id="my_modal_1{{ $report->id  }}" class="modal">
                        <div class="modal-box">
                            <h3 class="text-lg font-bold">Do you want to Delete</h3>
                            <p class="py-4">SS/{{ $report->id  }} is going to be deleted</p>
                            <div class="modal-action justify-center">
                                <form method="dialog">
                                    <!-- if there is a button in form, it will close the modal -->
                                    <button wire:click="deleteinvoice({{ $report->id  }})"
