        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 500%;  text-align: left; padding-left: 20px;">
                    <h1 style="margin: 0; font-weight: bold; font-size: 25px; font-family; 'Bodoni MT Black', serif;">
                        {{ $companydetails['company_name'] }}</h1>
                    <h6 style="margin: 0;">{{ $companydetails['address'] }}
                    </h6>
                    <h6 style="margin: 0;">Email: {{ $companydetails['email'] }} | Mobile:
                        {{ $companydetails['phone_number'] }}</h6>
                ...
                <table>
                    <tbody>
                        ...
                        @foreach ($orderbills as $index => $orderbill)
                            <tr>
                                <td style="text-align: right">Sample Invoice No</td>
                                <td style="text-align: center">:</td>
                                <td>SS/{{ str_pad($orderbill['id'], 4, '0', STR_PAD_LEFT) }}</td>
                            </tr>
                            <tr>
                                <td style="text-align: right">Sample Invoice Date</td>
                                <td style="text-align: center">:</td>
                ...
                <td colspan="2" style="text-align: center;">
                    <div style="margin: 0 auto; width: 80%;"> <!-- Center align the content -->
                        <p style="font-size: 9.64px;">
                            This document is issued for sample and evaluation purposes only.
                            The listed items are not considered a sale.
                            Samples must be returned in original condition within the agreed period, unless otherwise
